...
class NRConvBlockReduce(nn.Module):
    ...
    def forward(self, sp_tensor, batch_size, calib, stride, x_trans_train, trans_param):
        ...
        # # default
        d3_feat3 = replace_feature(d3_feat1, torch.cat([d3_feat1.features, d2_feat2.features], -1))
...
class VirConvL8x(nn.Module):
    def __init__(self, model_cfg, input_channels, grid_size,  **kwargs):
        ...
        self.vir_conv4 = NRConvBlockReduce(num_filters[2], num_filters[3], stride=2, padding=(0, 1, 1), indice_key='vir4')
