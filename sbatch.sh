...
#SBATCH -J VirConv-test-VirConv-T-T2-qat_backbone3d
#SBATCH --gres=gpu:1
...
python3 test.py --cfg_file cfgs/models/kitti/VirConv-T.yaml --extra_tag qat_backbone3d --ckpt ../ckpt/VirConv-T2.pth
